    ...
    <section id="contact" ref={ref} className="relative py-32 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold font-heading leading-[1.0] tracking-tight text-white mb-6">
            Ready to Start <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
            <button
              ...
              className="group relative px-8 py-4 bg-white text-black text-base font-semibold rounded-full overflow-hidden hover-target transition-all hover:scale-105 active:scale-95 cursor-none shadow-[0_0_40px_rgba(255,255,255,0.2)] hover:shadow-[0_0_60px_rgba(255,255,255,0.35)]"
            >
            ...
            <a
              ...
              className="px-6 py-4 text-gray-400 hover:text-white text-base font-medium transition-colors duration-300 flex items-center gap-2 cursor-none hover-target"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
